#ifndef EXACTKICHHOFFLOVE_H
#define EXACTKICHHOFFLOVE_H

#include "Model.h"

// Analytic elastic energy for a Kirchhoff-Love shell with St. Venant-Kirchhoff material

class ExactKirchhoffLove : public Model
{
public:
    ...
    virtual double measureVeeEnergy(
        ...
        double height)
    {
        // crease has infinite bending energy
