...
private:
        ...
        )
    {
        ...
        while (true)
        {
            ...
            Eigen::VectorXd F;
            double origEnergy = LibShell::ElasticShell<LibShell::MidedgeAngleTanFormulation>::elasticEnergy(mesh, curPos, edgeDOFs, mat, restState, &F, &Hcoeffs, LibShell::HessianProjectType::kNone);
            ...
            if (!LibShell::MidedgeAngleTanFormulation::edgeDOFsValid(mesh, curPos, newedgeDOFs))
            {
                std::cout << "Edge DOFs invalid" << std::endl;
                reg *= 2.0;
                continue;
            }
            double newenergy = LibShell::ElasticShell<LibShell::MidedgeAngleTanFormulation>::elasticEnergy(mesh, curPos, newedgeDOFs, mat, restState, NULL, NULL);
    ...
    {
        Eigen::VectorXd edgeDOFs;
		LibShell::MidedgeAngleTanFormulation::initializeExtraDOFs(edgeDOFs, mesh, restPos ? *restPos : curPos);            
        ...
        return LibShell::ElasticShell<LibShell::MidedgeAngleTanFormulation>::elasticEnergy(mesh, curPos, edgeDOFs, mat, restState, NULL, NULL);
    }
