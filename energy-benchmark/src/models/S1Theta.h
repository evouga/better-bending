...
class S1Theta : public Model
{
private:
    void optimizeEdgeDOFs(const LibShell::MeshConnectivity& mesh, 
        const Eigen::MatrixXd& curPos, 
        Eigen::VectorXd& edgeDOFs,
        const LibShell::StVKMaterial<LibShell::MidedgeAngleThetaFormulation> &mat,
        ...
        )
    {
        ...
        while (true)
        {
            ...
            Eigen::VectorXd F;
            double origEnergy = LibShell::ElasticShell<LibShell::MidedgeAngleThetaFormulation>::elasticEnergy(mesh, curPos, edgeDOFs, mat, restState, &F, &Hcoeffs, LibShell::HessianProjectType::kNone);
            ...
            double newenergy = LibShell::ElasticShell<LibShell::MidedgeAngleThetaFormulation>::elasticEnergy(mesh, curPos, newedgeDOFs, mat, restState, NULL, NULL);
    ...
    {
        Eigen::VectorXd edgeDOFs;
		LibShell::MidedgeAngleThetaFormulation::initializeExtraDOFs(edgeDOFs, mesh, restPos ? *restPos : curPos);
        ...
        LibShell::StVKMaterial<LibShell::MidedgeAngleThetaFormulation> mat;

        // initialize first and second fundamental forms to those of input mesh
        LibShell::ElasticShell<LibShell::MidedgeAngleThetaFormulation>::
        ...
        return LibShell::ElasticShell<LibShell::MidedgeAngleThetaFormulation>::elasticEnergy(mesh, curPos, edgeDOFs, mat, restState, NULL, NULL);
    }
